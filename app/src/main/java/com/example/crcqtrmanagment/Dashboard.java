...
public class Dashboard extends AppCompatActivity {
    ...
    private void setupRecyclerView() {
        ...
        adapter = new MyAdapter(this, dataList, isAdmin);
    ...
    private void setupFirebase() {
        ...
        eventListener = databaseReference.orderByChild("qtrNo").addValueEventListener(new ValueEventListener() {
            @Override
                ...
                for (DataSnapshot itemSnapshot : snapshot.getChildren()) {
                    try {
                        ...
                        if (dataClass != null) {
                            ...
                            //Log.d("Dashboard", "Data: " + dataClass.getQtrNo() + ", Title: " + dataClass.getQtrNo() + ", Description: " + dataClass.E() + ", Image: " + dataClass.getDataImage());
                        } else {
    ...
    private void setupFab() {
        ...
        fab.setOnClickListener(view -> {
            Intent uploadIntent = new Intent(Dashboard.this, UploadData.class);
    ...
    private void searchList(String text) {
        ...
        for (DataClass dataClass : dataList) {
            if (dataClass.getQtrNo() != null && dataClass.getQtrNo().toLowerCase().contains(text.toLowerCase())) {
